...
const AboutPage = () => {
  return (
    <div className="bg-gradient-to-b from-default-200 via-default-300 to-default-700 py-16">
      {/* About Us Section */}
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-4xl font-bold text-default-500 mb-6">About Us</h2>
      ...
      <div className="container mx-auto mt-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-center">
          <div className="bg-gradient-to-b from-default-700 via-default-600 to-default-500 p-8 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
      ...
      {/* Our Story Section */}
      <div className="container mx-auto mt-16 py-16 bg-gradient-to-r from-default-800 via-default-700 to-default-600 shadow-xl rounded-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
