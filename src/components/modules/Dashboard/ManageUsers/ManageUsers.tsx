...
//                 <TableColumn className="hidden lg:table-cell">VARIFIED</TableColumn>
...
//                         <span className="text-xs text-default-400 md:hidden">{new Date(user?.mobileNumber).toLocaleDateString()}</span>
//                       </div>
//                     </TableCell>
//                     <TableCell className="hidden md:table-cell">
//                       {user?.email}
...
//                         {user.isVerified? 'Varified' : 'Regular'}
//                       </Chip>
//                     </TableCell>
//                     <TableCell className="hidden lg:table-cell">
...
//                           <Button isIconOnly size="lg" variant="light" onPress={() => handleStatusChange(user)}>
